      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.headerRow}>
          ...
          <View style={styles.emisorBox}>
            ...
            <Text style={[styles.bold, styles.lineText]}>
            ...
            <Text style={styles.lineText}>
              Efecto del comprobante: I - Ingreso
            </Text>
          </View>
          ...
          <View style={styles.receptorBox}>
            ...
            {factura.receptor.direccion && (
              <Text style={styles.receptorLineText}>
                {factura.receptor.direccion}
              </Text>
            )}

            {factura.receptor.cp && (
              <Text style={styles.receptorInfoLine}>
                <Text style={styles.bold}>Código postal: </Text>
                {factura.receptor.cp}
              </Text>
            )}
            ...
            {factura.receptor.usoCfdi && (
              <Text style={styles.receptorInfoLine}>
                <Text style={styles.bold}>Uso del CFDI: </Text>
                {factura.receptor.usoCfdi}
              </Text>
            )}
            ...
            {factura.receptor.regimenFiscal && (
              <Text style={styles.receptorInfoLine}>
                <Text style={styles.bold}>Régimen Fiscal: </Text>
                {factura.receptor.regimenFiscal}
              </Text>
            )}
          </View>
        ...
        <View style={styles.exportRow}>
          ...
          <Text style={styles.exportValue}>
            {factura.exportacion ?? '01 - No aplica'}
          </Text>
        </View>
        ...
        {factura.conceptos.map((c, i) => {
          ...
          const ivaImporte =
            c.objetoImpuesto !== '01' ? importeConcepto * tasaIva : 0;
              ...
              <View style={styles.cDesc}>
                ...
                {c.noIdentificacion && (
                  <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.conceptoSubBold}>
                      No Identificación:{' '}
                    </Text>
                ...
                {c.objetoImpuesto !== '01' && (
                  <View>
                    ...
                    <Text style={styles.conceptoSub}>
                      IVA: 002, Base: {fmt(importeConcepto)}, Tasa:{' '}
                      {tasaIva.toFixed(6)}, Importe: {fmt(ivaImporte)}
                    </Text>
                  </View>
                )}
              </View>
        ...
        >
          <View style={{ flex: 1 }}>
            <View style={styles.monedaRow}>
              ...
              <Text style={styles.monedaValue}>
                {factura.moneda ?? 'MXN - Peso Mexicano'}
              </Text>
            </View>

            {factura.totalLetra && (
              <View style={styles.letraRow}>
                <Text style={styles.letraLabel}>Monto con letra:</Text>
            ...
            {factura.formaPago && (
              <View style={styles.monedaRow}>
                <Text style={styles.monedaLabel}>Forma de Pago:</Text>
            ...
            {factura.metodoPago && (
              <View style={styles.monedaRow}>
                <Text style={styles.monedaLabel}>Método de Pago:</Text>
